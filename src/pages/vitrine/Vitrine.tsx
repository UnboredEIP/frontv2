   ...
   const title = [
    ...
    return (
        <div className="d-flex col-12 flex-column align-items-center">
            ...
            <div className="col-6 ShowcaseBody">
                <p className="ShowcaseTitle"> Qu'est ce que Unbored ?</p>
                <img alt="" src={Logo} className="LogoUnbored"/>
            ...
            <div className="col-6 ShowcaseBody">
                ...
                <div className="">
                    <Carousel data-bs-theme="dark"  activeIndex={index} onSelect={handleSelect}>
                        {images.map((item, index) => {return (<Carousel.Item key={index}> <img alt="" src={item}/> </Carousel.Item>)})}
                    </Carousel>
