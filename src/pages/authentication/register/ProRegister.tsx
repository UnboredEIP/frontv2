        ...
        <div className='d-flex justify-content-center'>
            <div className='Card d-flex col-4 align-items-center flex-column py-auto mx-auto'>
                <div className='CardTitle my-1'>
                    <h1> Crée toi un compte professionel ! </h1>
                    <a href="/pro/login"> Ou connecte-toi si tu en a déjà un </a>
                </div>
                ...
                <Button className="pb-1" onClick={handleClick} name="Se connecter" backgroundColor='#e1604d' textColor='white'/>
            </div>
        </div>
    )
}
